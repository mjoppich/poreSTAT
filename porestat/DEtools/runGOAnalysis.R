...
for (GODB in c("BP", "MF", "CC")) { #
    ...
    kk <- enrichGO(entrezGenesC, organism, keyType="ENTREZID", ont=GODB, pvalueCutoff=0.5, pAdjustMethod="BH", universe=c(entrezGenesC, entrezBGC), qvalueCutoff=0.5, readable=TRUE)
    if (is.null(kk))
    {
