...
setup(name='porestat',
      ...
      zip_safe=False,
      install_requires=['pandas', 'scikit-learn', 'scipy', 'seaborn', 'networkx', 'statsmodels', 'upsetplot', 'natsort', 'numpy', 'scipy', 'matplotlib', 'pathos', 'openpyxl', 'h5py', 'htseq', "matplotlib-venn", "mpld3"]
      )
